 ...
 * @author luizam
 */
public class JdBuscaEdital extends javax.swing.JDialog {
    ...
    public JdBuscaEdital(java.awt.Frame parent, boolean modal) {
        super(parent, "Buscar Edital - " + versao.getVersao() + " - " + versao.getAno(), modal);
        initComponents();
        ...
        jrbTodosEditais.setSelected(true);
    ...
    private void initComponents() {
        ...
        jtbBuscaEdital.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jtbBuscaEdital.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtbBuscaEdital.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Ordem", "Nome do Usuário", "Tipo da Resolução", "Número Gerado", "Data da Solicitação", "Código"
            }
        ) {
        ...
        jtbBuscaEdital.setGridColor(new java.awt.Color(204, 204, 204));
        jtbBuscaEdital.setRowHeight(19);
        jtbBuscaEdital.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jtbBuscaEdital.getTableHeader().setReorderingAllowed(false);
        jtbBuscaEdital.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtbBuscaEditalMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtbBuscaEdital);
        ...
        jLabel8.setText("Tipo de Resolução: ");

        jrbTodosEditais.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jrbTodosEditais.setSelected(true);
        jrbTodosEditais.setText("Todos");
        jrbTodosEditais.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jrbTodosEditaisActionPerformed(evt);
            }
        });
                ...
                .addGroup(jpEditalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpEditalLayout.createSequentialGroup()
                        ...
                        .addGroup(jpEditalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jrbTodosEditais)
                            .addComponent(jtfBuscaUsuario))
                        .addGap(26, 26, 26))
                    .addGroup(jpEditalLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nº Editais Gerados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        jPanel1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("Edital: ");

        lbEdital.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbEdital.setText("lbEdital");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jpEdital, javax.swing.GroupLayout.DEFAULT_SIZE, 499, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jtbBuscaEditalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbBuscaEditalMouseClicked
    ...
    }//GEN-LAST:event_jtbBuscaEditalMouseClicked

    private void jrbTodosEditaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbTodosEditaisActionPerformed

        if (jrbTodosEditais.isSelected() == true) {
            modeloEdital = "EDITAL";
        }

    }//GEN-LAST:event_jrbTodosEditaisActionPerformed
    ...
    private javax.swing.JRadioButton jrbTodosEditais;
    private javax.swing.JTable jtbBuscaEdital;
    private javax.swing.JTextField jtfBuscaUsuario;
    private javax.swing.JLabel lbEdital;
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void cancelar() {
        ...
        DefaultTableModel modelo = (DefaultTableModel) jtbBuscaEdital.getModel();
    ...
    public void pesquisar() {
        ...
        jtbBuscaEdital.setRowSorter(tabelaSorter);
        ...
        List listaEdital = new ArrayList();
        Date dataSolic;

        if (jDateChooserBuscaSolicitacao.getDate() == null) {
            listaEdital = dao.listarEdital(controleUsuario.getCodigoUsuario(jtfBuscaUsuario.getText()), null, modeloEdital, TIPOEDITAL, String.valueOf(jYearChooserAnoOficio.getYear()));
        } else {
            //try {
            ...
            //    Logger.getLogger(jdBuscaAgendamento.class.getName()).log(Level.SEVERE, null, ex);
            //}
            listaEdital = dao.listarEdital(controleUsuario.getCodigoUsuario(jtfBuscaUsuario.getText()), jDateChooserBuscaSolicitacao.getDate(), modeloEdital, TIPOEDITAL, String.valueOf(jYearChooserAnoOficio.getYear()));
        }
        ...
        for (int i = 0; i < listaEdital.size(); i++) {

            edit = (Edital) listaEdital.get(i);

            modelo.addRow(new String[]{editaOrdemTabela.editaOrdem(i + 1), edit.getUsuario().getNomeUsuario(), edit.getModeloEdital(), String.valueOf(edit.getNumero()), String.valueOf(edit.getDataSolicitacao()), String.valueOf(edit.getCodigoEdital())});

        }

        if (jtbBuscaEdital.getRowCount() > 0) {
            jtbBuscaEdital.getSelectionModel().setSelectionInterval(0, 0);
        } else {
            iniciaClasseGeral();
            
            classeGeral.msgInforma("Não há Edital com estes dados!");
        }
    ...
    public void buscaDados() {
        ...
        codigo = Integer.valueOf((String) jtbBuscaEdital.getValueAt(jtbBuscaEdital.getSelectedRow(), 5));

        edital = (Edital) dao.busca(edital, codigo);
        dao.encerraSessao();
...
//Getters and Setters===========================================================================================================================================
    ...
    public void setNumeroEdital() {

        iniciaDao();
        //DAO dao = new DAO();

        lbEdital.setText("" + dao.getNumeroGeradoEdital(versao.getAno(), TIPOEDITAL));
