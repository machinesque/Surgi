 ...
 * @author luizam
 */
public class JdBuscaResolucao extends javax.swing.JDialog {
    ...
    private String modeloResol = "RESOLUCAO";
    ...
    public JdBuscaResolucao(java.awt.Frame parent, boolean modal) {
        super(parent, "Buscar Resolução - " + versao.getVersao() + " - " + versao.getAno(), modal);
        initComponents();
        ...
        jrbTodosResolucoes.setSelected(true);
    ...
    private void initComponents() {
        ...
        jrbTodosResolucoes = new javax.swing.JRadioButton();
        ...
        jtbBuscaPortaria.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ordem", "Nome do Usuário", "Tipo da Resolução", "Assunto", "Número Gerado", "Data da Solicitação", "Código"
            }
        ) {
        ...
        btgTipoOficio.add(jrbTodosResolucoes);
        jrbTodosResolucoes.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jrbTodosResolucoes.setSelected(true);
        jrbTodosResolucoes.setText("Todos");
        jrbTodosResolucoes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jrbTodosResolucoesActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jrbTodosResolucoes)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jDateChooserBuscaSolicitacao, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1)
                    .addComponent(jLabel3)
        ...
        lbResolucao.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbResolucao.setText("lbResolucao");
    ...
    private void jrbTodosResolucoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbTodosResolucoesActionPerformed

        if (jrbTodosResolucoes.isSelected() == true) {
            modeloResol = "RESOLUCAO";
        }

    }//GEN-LAST:event_jrbTodosResolucoesActionPerformed
    ...
    private javax.swing.JRadioButton jrbTodosResolucoes;
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void pesquisar() {
        ...
        List listaResolucao = new ArrayList();
        Date dataSolic;

        if (jDateChooserBuscaSolicitacao.getDate() == null) {
            listaResolucao = dao.listarResolucao(controleUsuario.getCodigoUsuario(jtfBuscaUsuario.getText()), null, modeloResol, TIPORESOLUCAO, String.valueOf(jYearChooserAnoOficio.getYear()));
        } else {
            //try {
            ...
            //    Logger.getLogger(jdBuscaAgendamento.class.getName()).log(Level.SEVERE, null, ex);
            //}
            listaResolucao = dao.listarResolucao(controleUsuario.getCodigoUsuario(jtfBuscaUsuario.getText()), jDateChooserBuscaSolicitacao.getDate(), modeloResol, TIPORESOLUCAO, String.valueOf(jYearChooserAnoOficio.getYear()));
        }
        ...
        for (int i = 0; i < listaResolucao.size(); i++) {

            iniciaUsuario();
            resol = (Resolucao) listaResolucao.get(i);
            usuario = (Usuario) resol.getUsuario();
            
            modelo.addRow(new String[]{editaOrdemTabela.editaOrdem(i + 1), usuario.getNomeUsuario(), resol.getModeloResolucao(), resol.getAssuntoResolucao(), String.valueOf(resol.getNumero()), String.valueOf(resol.getDataSolicitacao()), String.valueOf(resol.getCodigoResolucao())});
        ...
        if (jtbBuscaPortaria.getRowCount() > 0) {
            ...
            iniciaClasseGeral();
            classeGeral.msgInforma("Não há Resolução com estes dados!");
        }
    ...
    public void buscaDados() {
        ...
        resolucao = (Resolucao) dao.busca(resolucao, codigo);
        dao.encerraSessao();
...
//Getters and Setters===========================================================================================================================================
    ...
    public void setNumeroResolucao() {

        iniciaDao();
        //DAO dao = new DAO();

        lbResolucao.setText("" + dao.getNumeroGeradoResolucao(versao.getAno(), TIPORESOLUCAO));
    ...
    public void getPermissoes() {
        ...
        visualizarTodos = permissoes.isVisualizarTodosResolucoes();
    }
