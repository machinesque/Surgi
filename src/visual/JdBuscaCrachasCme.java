 ...
 * @author luizam
 */
public class JdBuscaCrachasCme extends javax.swing.JDialog {
    ...
    public JdBuscaCrachasCme(java.awt.Frame parent, boolean modal) {
        super(parent, "Buscar Crachás CME - " + versao.getVersao() + " - " + versao.getAno(), modal);
        initComponents();
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void pesquisar() {
        ...
        List listaCrachasCme = new ArrayList();
        Date dataCracha;
        ...
        listaCrachasCme = dao.listarCrachasCme(jtfBuscaNome.getText(), jtfBuscaDepartamento.getText(), jtfBuscaCargo.getText(), dataCracha);
        //listaAgendamento = dao.listarAgendamento(nomeEntid, new java.sql.Date(dataSolic.getTime()), tipoEntid);Usando jFormatedTextField
            
        modelo.setRowCount(0);

        for (int i = 0; i < listaCrachasCme.size(); i++) {

            iniciaCrachasCme();
            
            crachasCme = (CrachasCme) listaCrachasCme.get(i);

            modelo.addRow(new String[]{String.valueOf(crachasCme.getCodigoCrachaCme()), crachasCme.getNomeCracha1(), crachasCme.getDepartamentoCracha1(), crachasCme.getCargoCracha1(), crachasCme.getNomeCracha2(), 
                crachasCme.getDepartamentoCracha2(), crachasCme.getCargoCracha2(), crachasCme.getNomeCracha3(), crachasCme.getDepartamentoCracha3(), crachasCme.getCargoCracha3(), crachasCme.getNomeCracha4(),
                crachasCme.getDepartamentoCracha4(), crachasCme.getCargoCracha4()});
    ...
    public void buscaDados() {
        ...
        crachasCme = (CrachasCme) dao.busca(crachasCme, codigo);
        dao.encerraSessao();
...
//Getters and Setters===========================================================================================================================================
    ...
    public CrachasCme getCrachasCme() {

        return crachasCme;

    }

    public void setCrachasCme() {
        crachasCme = null;
    }
