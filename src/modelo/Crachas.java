 ...
 */
@Entity
@Table(name = "crachas", schema = "public")
public class Crachas implements java.io.Serializable {
    
    private int codigoCrachas;
    ...
    public Crachas(int codigoCrachas, String cargoCracha1, String cargoCracha2, String cargoCracha3, String cargoCracha4, String departamentoCracha1, String departamentoCracha2, 
        ...
        this.codigoCrachas = codigoCrachas;
    ...
    @Id
    @SequenceGenerator(name = "SEQUENCE_CRACHAS", sequenceName = "crachas_sequence", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQUENCE_CRACHAS")
    @Column(name = "codigocrachas", unique = true, nullable = false)
    public int getCodigoCrachas() {
        return codigoCrachas;
    }

    public void setCodigoCrachas(int codigoCrachas) {
        this.codigoCrachas = codigoCrachas;
    }
